          ...
          <div className="svc-accordion">
            {[
              { 
                ...
                desc: "Administración profesional para que tu marca nunca deje de crecer.", 
                adv: "Consistencia garantizada, ahorro de tiempo y presencia estratégica alineada a tus objetivos." 
              },
              { 
                title: "Creación de Contenido", 
                desc: "Piezas visuales que captan la atención en el primer segundo.", 
                adv: "Estética cuidada, contenido de alto valor y diferenciación clara frente a la competencia." 
              },
              { 
                title: "Copywriting & Storytelling", 
                desc: "Textos que no solo informan, sino que emocionan y venden.", 
                adv: "Conexión real con tu audiencia, aumento de interacción y llamados a la acción efectivos." 
              },
              { 
                title: "Estrategia de Crecimiento", 
                desc: "Planes a medida para llegar a personas que realmente te necesitan.", 
                adv: "Alcance orgánico maximizado, segmentación inteligente y resultados sostenibles en el tiempo." 
              },
              { 
                title: "Análisis & Reportes", 
                desc: "Decisiones basadas en datos, no en suposiciones.", 
                adv: "Claridad sobre qué funciona, optimización constante de la inversión y transparencia total." 
              },
              { 
                title: "Community Building", 
                desc: "Transformamos seguidores en una comunidad fiel a tu marca.", 
                adv: "Fidelización de clientes, gestión de mensajes y fomento de conversaciones genuinas." 
              }
            ].map((s, i) => (
              <details key={i} className="svc-item">
                ...
                <div className="svc-content">
                  ...
                  <p className="svc-adv"><b>Ventaja:</b> {s.adv}</p>
                </div>
              </details>
            ))}
          </div>
